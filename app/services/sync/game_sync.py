    ...
    async def sync_game_stats(self, game_id: int) -> dict:
        ...
        for ts in stats_data.get("teams", []):
            ...
            stmt = insert(GameTeamStats).values(
                ...
                xg=stats.get("xg"),
                freekicks=stats.get("freekick"),
                freekick_shots=stats.get("freekick_shot"),
                freekick_passes=stats.get("freekick_pass"),
                throw_ins=stats.get("out"),
                goal_kicks=stats.get("goal_kick"),
                assists=stats.get("goal_pass"),
                passes_forward=stats.get("pass_forward"),
                passes_progressive=stats.get("pass_progressive"),
                key_passes=stats.get("key_pass"),
                passes_to_final_third=stats.get("pass_to_3rd"),
                passes_to_box=stats.get("pass_to_box"),
                crosses=stats.get("pass_cross"),
                shot_accuracy=stats.get("shot_ratio"),
                corner_accuracy=stats.get("corner_ratio"),
                freekick_shot_accuracy=stats.get("freekick_shot_ratio"),
                freekick_pass_accuracy=stats.get("freekick_pass_ratio"),
                throw_in_accuracy=stats.get("out_ratio"),
                goal_kick_accuracy=stats.get("goal_kick_ratio"),
                penalty_accuracy=stats.get("penalty_ratio"),
            ...
            stmt = stmt.on_conflict_do_update(
                ...
                set_={
                    ...
                    "xg": stmt.excluded.xg,
                    "freekicks": stmt.excluded.freekicks,
                    "freekick_shots": stmt.excluded.freekick_shots,
                    "freekick_passes": stmt.excluded.freekick_passes,
                    "throw_ins": stmt.excluded.throw_ins,
                    "goal_kicks": stmt.excluded.goal_kicks,
                    "assists": stmt.excluded.assists,
                    "passes_forward": stmt.excluded.passes_forward,
                    "passes_progressive": stmt.excluded.passes_progressive,
                    "key_passes": stmt.excluded.key_passes,
                    "passes_to_final_third": stmt.excluded.passes_to_final_third,
                    "passes_to_box": stmt.excluded.passes_to_box,
                    "crosses": stmt.excluded.crosses,
                    "shot_accuracy": stmt.excluded.shot_accuracy,
                    "corner_accuracy": stmt.excluded.corner_accuracy,
                    "freekick_shot_accuracy": stmt.excluded.freekick_shot_accuracy,
                    "freekick_pass_accuracy": stmt.excluded.freekick_pass_accuracy,
                    "throw_in_accuracy": stmt.excluded.throw_in_accuracy,
                    "goal_kick_accuracy": stmt.excluded.goal_kick_accuracy,
                    "penalty_accuracy": stmt.excluded.penalty_accuracy,

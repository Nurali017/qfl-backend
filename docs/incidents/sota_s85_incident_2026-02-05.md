# SOTA Incident Report: Season 85

- Generated at (UTC): 2026-02-05T23:39:43.972143+00:00
- Mode: dry-run

## Symptoms
- Local no-events matches: 10
- Local duplicate events (signature-based): 0
- Starter anomalies before remediation: `166` / `182`
- Zero-starter matches before remediation: 1

## Evidence
- `em/list` missing rows in CSV: 10
- `em/team` missing ids rows in CSV: 69
- `em/team` missing amplua rows in CSV: 1
...
- Local no-events matches: 10 (expected source gap only)
- Local duplicate events: 0
- Starter anomalies after remediation: `166` / `182`
- Zero-starter matches after remediation: 1

## Reproduction Steps
Use a valid SOTA token (`<TOKEN>`) in requests below.
```bash
curl "https://sota.id/em/93699baf-102e-4ac4-9b4e-6638c5960461-list.json?access_token=<TOKEN>"
curl "https://sota.id/em/e3c76a11-2957-4a93-8da1-288417bb78dc-team-home.json?access_token=<TOKEN>"
curl "https://sota.id/em/e3c76a11-2957-4a93-8da1-288417bb78dc-team-away.json?access_token=<TOKEN>"
```
